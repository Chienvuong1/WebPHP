...
<body class="js">
									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													...
													<li><a href="#khuyenmai">Khuyễn mãi</a></li>									
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="res.php">Đăng ký</a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<!-- Start Contact -->
        ...
        <form action="res_submit.php" method="post">
            ...
            <div class="agile-field-txt">
                ...
                <input type="password" name="repassword" placeholder="Nhập lại mật khẩu" required="" id="myInput1"  />
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							...
							<p class="text">Cảm ơn bạn đã luôn tin tưởng và sử dụng sản phẩm của chúng tôi</p>
							<p class="call">Mọi thắc mắc liên hệ<span><a href="tel:123456789">support@gmail.com</a></span></p>
						</div>
						<!-- End Single Widget -->
					</div>
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-footer social">
							...
							<div class="contact">
								<ul>
									<li>PTIT</li>
									<li>Km 10 Nguyễn trãi Hà Đông</li>
									<li>docmenswear@eshop.com</li>
									<li>+084 3456 7890</li>
								</ul>
							</div>
							<!-- End Single Widget -->
